...
async function execute(interaction: ComponentInteraction) {
      ...
      embeds: [
        {
          ...
          fields: [
            ...
            { name: "Denial ID", value: `${suggestion.id}`, inline: true },
          ],
        },
      ],
    },
  ...
  embed.color = interaction.colors.error;
  ...
  await interaction.editOriginal(
    interaction.getSuccessReply("Suggestion has been rejected successfully.")
  );
}

export = {
  id: "action.suggestion.reject",
  execute,
};
